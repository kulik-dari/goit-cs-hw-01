...
class TokenType:
    ...
    PLUS = "PLUS"
    MINUS = "MINUS"
    MUL = "MUL"        # Додано для множення
    DIV = "DIV"        # Додано для ділення
    LPAREN = "LPAREN"  # Додано для відкриття дужки
    RPAREN = "RPAREN"  # Додано для закриття дужки
...
class Lexer:
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            ...
            # Додано підтримку множення
            if self.current_char == "*":
                self.advance()
                return Token(TokenType.MUL, "*")

            # Додано підтримку ділення
            if self.current_char == "/":
                self.advance()
                return Token(TokenType.DIV, "/")

            # Додано підтримку дужок
            if self.current_char == "(":
                self.advance()
...
class Interpreter:
    ...
    def visit_BinOp(self, node):
        if node.op.type == TokenType.PLUS:
            ...
            # Повертаємо ціле число, якщо результат ділення без залишку
